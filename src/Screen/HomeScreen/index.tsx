...
type Props = NativeStackScreenProps<HomeStackParamList, typeof HomeStackRoutes.HOME>
        ...
        <ScrollView
          ...
          <View style={{
            ...
            <Pressable
              ...
              onPress={() => rootNavigation.navigate(RootStackRoutes.SEARCH_PRODUCT)}>
          ...
          <View
            ...
            <Pressable
              onPress={() => navigation.navigate(HomeStackRoutes.ALL_CATEGORIES)}
