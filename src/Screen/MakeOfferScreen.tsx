...
type Props = NativeStackScreenProps<RootStackParamList, typeof RootStackRoutes.MAKE_OFFER>
  ...
  return (
    <View style={{ flex: 1, padding: 15 }}>
      <View
        ...
        <View style={{ flex: 1 }}>
          <Text style={{ fontWeight: '600', fontSize: 16 }}>{route.params.productName}</Text>
